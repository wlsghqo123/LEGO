...
<head>
<meta charset="UTF-8">
<title>Unofficial LEGO® Shop</title>
<link rel="stylesheet" href="lego.css" type="text/css">
</head>
<body>
	<header>
	...
	<div id="spotlight">
		<div id="spot_left"></div>
		<div id="spot_right"></div>
	</div>
	<div id="magazine"></div>
	<div id="contact"></div>
